	      ...
	      <div class="section group">
	      	...
	      	if ($search){
				...
				<div class="grid_1_of_4 images_1_of_4">
				     ...
				     <div class="button"><span><a href="details.php?proid=<?php echo $result['idthuoc']?>&qty=<?php echo $result['productQuantity']?>&sold=<?php echo $result['product_soldout']?>&product_remain=<?php echo $result['product_remain']?>" class="details">Chi tiết</a></span></div>
				</div>
				<?php
			}
		}
